...
const BackgroundParticles = styled.div`
  ...
  width: 100%;
  height: 100%;
  // background: url('https://www.transparenttextures.com/patterns/50-percent-transparent.png');
...
const ChatWindow = styled(Paper)`
  ...
  ::-webkit-scrollbar-thumb {
    background: #003366; /* Dark blue scrollbar thumb */
    border-radius: 4px;
  }
...
const Chatbot = () => {
  ...
  return (
    <PageContainer>
      ...
      <ChatbotContainer>
        <ChatHeader>iTax Chatbot</ChatHeader>
